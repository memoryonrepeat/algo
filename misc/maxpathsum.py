...
class Solution:
    ...
    def dfs(self, root):
        ...
        # Final result has to consider paths that goes through:
        # - root only
        ...
        # but in the end it will still fall behind left or right sum due to the universal comparison againts self.result above.
